...
<form action="https://hook.integromat.com/pjqk9gtx51spuu1j8vj6why48yoccfn2" accept-charset="utf-8" method="post" style="position: relative;" class="d-flex getresponse-form" validate>
  ...
  <!-- Skąd idzie zapis -->
  <input type="hidden" name="origin" value="front-page">
  <!-- Przycisk zapisu -->
  <input type="submit" id="{{ $uniq_id }}" value="{{ the_field('getresponse_submit_section', 'options') }}" class="btn btn--large btn--green btn--subscribe" style="top: 0" data-ga-action="newsletter-section"/>
</form>